...
class User:
    ...
    def _supports_queries(self):
        ...
        if self.type == 'pornstar' and utils.head(self.client, utils.concat(videos_url, 'upload')):
            index.upload = utils.concat(videos_url, 'upload')
        return index
